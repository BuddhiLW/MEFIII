...
(use '(incanter core io excel charts stats datasets))
(env/bootstrap-repl!)
;; (map (derivative #(* % %)) [2 4 6])
(read-xls "../../data/CondTerm-dados.xlsx")
;; [[file:~/PP/Faculdade/MEFIII/exp6-cod/incanter-plots/data/CondTerm-dados.xlsx][file:~/PP/Faculdade/MEFIII/exp6-cod/incanter-plots/data/CondTerm-dados.xlsx
